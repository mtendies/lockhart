...
const TUTORIAL_SCREENS = [
  {
    ...
    content: "Let's take 60 seconds to show you how to get the most out of your personal health advisor.",
    cta: "Let's Go",
  },
  {
    id: 'home',
    ...
    bullets: [
      'Quick entry box for fast logging',
      'Focus Goals at a glance',
      'Nutrition tracking (Week 1)',
    ],
  },
  {
    id: 'advisor',
    ...
    iconBg: 'bg-violet-50',
    title: 'Advisor',
    subtitle: 'Chat with your personal advisor.',
    bullets: [
      'Ask anything about nutrition, fitness, or goals',
      'Bookmarks for saving insights',
  ...
  },
  {
    ...
    iconBg: 'bg-green-50',
    title: 'Nutrition',
    content: 'Complete a 5-day calibration to unlock personalized insights.',
    bullets: [
      'Grocery analysis & smart swaps',
      'Calorie estimates per meal',
      'Choose your tracking style after Week 1',
    ],
    tagline: 'No obsessive tracking required.',
  },
  {
    id: 'training',
    icon: ClipboardList,
    ...
    iconBg: 'bg-orange-50',
    title: 'Training',
    subtitle: 'Log and track your workouts.',
    bullets: [
      'Track workouts and progress',
      'Personal records (PRs)',
      'Get AI recommendations',
    ],
    tagline: 'Build strength. Track progress.',
  },
  {
    id: 'connected',
    icon: Link2,
    ...
    example: 'Tell the Advisor "I ran 3 miles" → Focus Goals update → Check-in sees it.',
    highlight: 'Log once. Updates everywhere.',
    tagline: 'Your data flows automatically.',
  },
  {
    id: 'checkin',
    icon: Calendar,
    ...
    subtitle: 'Every Sunday, reflect on your week.',
    bullets: [
      '90% pre-filled by Lockhart',
      'Takes ~2 minutes to complete',
      'Helps refine your playbook',
    ],
    tagline: 'Your weekly reset.',
  },
  {
    id: 'first-week',
    icon: Zap,
  ...
  },
  {
    ...
    content: 'Lockhart is ready when you are.',
    subtitle: 'Start by logging your first meal or workout on the Home page.',
    cta: 'Go to Home',
    ctaIcon: true,
